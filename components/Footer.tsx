...
export function Footer() {
  return <footer className="border-t border-[#28282e] bg-[#0a0a0d]">
    <div className="container-shell grid gap-10 py-14 md:grid-cols-[1.3fr_1fr_1fr]">
      ...
      <div><p className="eyebrow">On the ground</p><p className="mt-4 text-sm leading-7 text-[#9a9aa4]">Kanpur · Lucknow · Gorakhpur<br />Uttar Pradesh, India</p><a href="mailto:founder@oryzene.com" className="mt-3 inline-block text-sm text-[#f2b542]">founder@oryzene.com</a></div>
    </div>
